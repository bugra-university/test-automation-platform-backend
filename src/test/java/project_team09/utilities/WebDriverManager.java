...
/**
 * Enhanced WebDriver Manager with configuration support
...
public class WebDriverManager {
    ...
    // Track all active drivers for cleanup
    ...
    /**
     * Initialize WebDriver with configuration from system properties
     */
    public static void initializeDriver() {
        // Get configuration from system properties (set by TestExecutionService)
        boolean isHeadless = Boolean.parseBoolean(System.getProperty("webdriver.headless", "false"));  // Default to visible browser
    ...
    /**
     * Initialize WebDriver with specific configuration
     */
    ...
    private static WebDriver createChromeDriver(TestConfiguration config) {
        // Setup ChromeDriver automatically using Bonigarcia WebDriverManager
    ...
    /**
     * Quit current driver and clean up
     */
    ...
    /**
     * Emergency cleanup - quit all active drivers
     */
    public static void quitAllDrivers() {
        ...
        for (Map.Entry<String, WebDriver> entry : activeDrivers.entrySet()) {
            try {
                ...
                System.err.println("[WebDriverManager] Error quitting driver " + entry.getKey() + ": " + e.getMessage());
            }
        }
    ...
    /**
     * Get browser info for reporting
     */
    ...
    /**
     * Check if driver is initialized and ready
     */
