...
public class Tc10 extends ExtentReport {
        ...
        public void test01() {
                ...
                // "Please enter your current password." mesajının cıktığını doğrula
                String expectedMsj = "Please enter your current password.";
                WebElement errorElement = Driver.getDriver().findElement(
                                By.xpath("//*[@class=' alert alert-simple alert-icon alert-close-top alert-danger']"));
