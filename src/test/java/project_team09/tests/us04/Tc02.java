...
//"First name" kutusunu boş bırak
        shipping .firstNameBox.clear();
        extentTest.info("FIRST NAME KUTUSU BOS BIRAKILDI");
...
//"First name is a required field." mesajı  görülmeli ve adres kayıt isleminin yapılamadığını doğrula
        String expectedMsj="First name is a required field.";
        String actualMsj=Driver.getDriver().findElement(By.xpath("//*[@data-id='shipping_first_name']")).getText();
