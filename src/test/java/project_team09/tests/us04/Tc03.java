...
//"Last name is a required field." mesajı  görülmeli ve adres kayıt isleminin yapılamadığını doğrula
        String expectedMsj="Last name is a required field.";
        String actualMsj=Driver.getDriver().findElement(By.xpath("//*[@data-id='shipping_last_name']")).getText();
