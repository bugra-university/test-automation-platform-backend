...
public class Tc07 extends ExtentReport {
        ...
        public void test01() {
                ...
                // "Street address" ikinci kutusunu boş bırak
                /*
                 * BU STEP DE YANLIŞ İKİNCİ KUTU BOŞ BIRAKILDIĞINDA EDİTLEME İSLEMİ BASARI İLE
                 * GERÇEKLEŞİYOR.
                 * AMA BEN TC DE İKİNCİ KUTU BOŞ BIRAKILDIĞINDA EDİT İSLEMİ YAPILAMIYOR DİYE
                 * YAZDIM
                 */
                shipping.streetAddressSeccondBox.clear();
                extentTest.info("STREET ADRESS BOLUMUNDEKI IKINCI KUTU BOS BIRAKILDI");
                ...
                // "Street address is a required field." mesajının çıktığını doğrula
                String expectedMsj = "Street address is a required field.";
                ...
                extentTest.info("Street address is a required field. MESAJININ CIKTIGI DOGRULANDI");
