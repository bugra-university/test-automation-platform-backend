...
//"Street address" ilk butona house number ve street name bos bırak
        shipping.streetAddressFirstBox.clear();
        ReusableMethods.bekle(2);
        extentTest.info("STREET ADRESS BOLUMUNDEKI ILK KUTU BOS BIRAKILDI");
...
//"Street address is a required field." mesajının çıktığını doğrula
        ...
        String actualMsj=Driver.getDriver().findElement(By.xpath("//*[@data-id='shipping_address_1']")).getText();
